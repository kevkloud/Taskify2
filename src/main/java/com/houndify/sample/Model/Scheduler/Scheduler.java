package com.houndify.sample.Model.Scheduler;

import android.util.Log;

import com.firebase.client.Firebase;
import com.houndify.sample.Model.Events.TaskifyCalendarEvent;
...
public class Scheduler {
    ...
    private void scheduleTasks() {
        ...
        DateTime dateTime = new DateTime(now.getYear(), now.getMonthOfYear(), now.getDayOfMonth(), (now.getHourOfDay() == 23) ? 0 : now.getHourOfDay() + 1, 0);
